...
const PROJECTS = [
    ...
    { name: 'Inventory Management', url: 'http://inventory-hjza.onrender.com/' },
    { name: 'ClimateNow', url: 'https://heyiamuday.github.io/ClimateNow/' },
    { name: 'CV App – React', url: 'https://cv-app-uday.netlify.app/' },
    { name: 'Shopping Cart', url: 'https://shopping-cart-uday.netlify.app/' },
    { name: 'Tic-Tac-Toe', url: 'https://udaydocs.github.io/Tic-Tac-Toe/' },
]
            ...
            <div className="container">
                ...
                <div className="achievements-wrapper">
                    ...
                    <AchCard delay={0.1} title="Hacking Progress" icon={
                        ...
                        <div className="ach-card-title" style={{ color: 'var(--sage)', marginTop: 16 }}>
